...
Metode yang dipilih adalah regresi multivariat dengan 2 variabel independen. Pengujian dilakukan dengan asumsi klasik yaitu, Uji F (simultan) dan Uji t (parsial). Penelitian ini bermaksud mencari hubungan jumlah uang beredar dan inflasi terhadap Indeks Harga Konsumen. Spesifikasi yang dilakukan adalah:
...
![Gambar 1. Indeks Harga Konsumen](GRAFIK IHK.png){fig-align="center" width="519"}
...
![Gambar 2. Inflasi](Grafik Inflasi.png){fig-align="center" width="519"}
